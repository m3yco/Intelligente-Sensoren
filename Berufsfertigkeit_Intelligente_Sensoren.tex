...
\begin{tikzpicture}[node distance=4cm,
  ...
  \end{tikzpicture}
\end{adjustbox}
  \caption{Schema Komponenten im Sensor (Sensoren und Sensorschnittstellen, Seite 14)}
